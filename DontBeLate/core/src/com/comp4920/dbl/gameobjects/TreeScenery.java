...
public class TreeScenery implements Scenery {
	public static enum TreeType {
	    NORMAL, FLIPPED, INVERTED, FLIPVERTED
	}
	...
	public TreeScenery(int x, int y, TreeType type) {
		stopped = false;
        ...
        switch (type) {
    		case NORMAL: treeAnimation = AssetLoader.treeAnimation; break;
    		case FLIPPED:treeAnimation = AssetLoader.treeAnimation2; break;
    		case INVERTED:treeAnimation = AssetLoader.treeAnimation3; break;
    		case FLIPVERTED:treeAnimation = AssetLoader.treeAnimation4; break;  
        }
	}
