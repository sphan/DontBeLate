...
public class GameScreen implements Screen {
	...
	public GameScreen(DBL g) {
		...
		gameInterfaceRenderer = new GameInterfaceRenderer(this, world, camera,
		        (int) gameWidth, midPointX);
		gameRenderer = new GameWorldRenderer(world,
		        gameInterfaceRenderer.getStage(), camera, (int) gameWidth,
		        midPointX);
	...
	public void resize(int width, int height) {
		...
		gameInterfaceRenderer.getStage().getViewport()
	 ...
	 */
	private static GameScreen _this = null;

	/**
	 * Game is not singleton
	 */
	public static GameScreen getInstance(DBL g) {
		// if (_this == null) {
		// _this = new GameScreen(g);
		// }
		// return _this;
